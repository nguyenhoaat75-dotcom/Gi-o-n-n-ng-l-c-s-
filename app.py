...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Hoa - Trường Tiểu học Hùng An - ĐT: 0859900907</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Hoa - Trường Tiểu học Hùng An - ĐT: 0859900907</div>", unsafe_allow_html=True)
